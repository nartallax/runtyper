function (exports, require, tslib_1, __RuntyperAutogeneratedImport, simple_1) {
    ...
    __RuntyperAutogeneratedImport.internal.v([[
            ...
            "/types/destructurizing:ArrayWithoutExplicitType.c",
            { type: "index_access", index: { type: "constant", value: 0 }, object: { type: "array", valueType: { type: "union", types: [{ type: "number" }, { type: "string" }] } } }
        ], [
            "/types/destructurizing:ArrayWithoutExplicitType.d",
            { type: "index_access", index: { type: "constant", value: 1 }, object: { type: "array", valueType: { type: "union", types: [{ type: "number" }, { type: "string" }] } } }
        ], [
            "/types/destructurizing:MixedDestr.b",
            { type: "index_access", index: { type: "constant", value: 0 }, object: { type: "index_access", index: { type: "constant", value: "a" }, object: { type: "index_access", index: { type: "constant", value: 1 }, object: { type: "array", valueType: { type: "union", types: [{ type: "constant", value: null }, { type: "object", properties: { a: { type: "array", valueType: { type: "number" } } } }] } } } } }
        ], [
            "/types/destructurizing:MixedDestr.d",
            { type: "index_access", index: { type: "constant", value: "d" }, object: { type: "index_access", index: { type: "constant", value: 0 }, object: { type: "index_access", index: { type: "constant", value: "c" }, object: { type: "object", properties: { c: { type: "array", valueType: { type: "object", properties: { d: { type: "string" } } } } } } } } }
        ], [
            "/types/destructurizing:NamedTypedDestruct.myPoint",
            ...
            "/types/destructurizing:NamedTypedDestruct.ppp",
            { type: "index_access", index: { type: "constant", value: 0 }, object: { type: "array", valueType: { type: "array", valueType: { type: "value_reference", name: "/types/destructurizing:NamedTypedDestruct.myPoint" } } } }
        ], [
            "/types/destructurizing:NamedTypedDestruct.pppp",
            { type: "index_access", index: { type: "constant", value: 0 }, object: { type: "array", valueType: { type: "array", valueType: { type: "type_reference", name: "/types/destructurizing:NamedTypedDestruct.Point2", typeArguments: [{ type: "number" }] } } } }
        ], [
            "/types/destructurizing:NamedTypedDestruct.ppppp",
            { type: "index_access", index: { type: "constant", value: 0 }, object: { type: "array", valueType: { type: "array", valueType: { type: "value_reference", name: "/types/simple:typePointToBeRequiredExternally" } } } }
        ], [
            "/types/destructurizing:NamedTypedDestruct.pppppp",
            ...
            "/types/destructurizing:RestDestr.x",
            { type: "index_access", index: { type: "constant", value: 0 }, object: { type: "index_access", index: { type: "constant", value: "x" }, object: { type: "object", properties: { x: { type: "array", valueType: { type: "number" } } } } } }
        ], [
            "/types/destructurizing:RestDestr.y",
            { type: "index_access", index: { type: "constant", value: 1 }, object: { type: "index_access", index: { type: "constant", value: "x" }, object: { type: "object", properties: { x: { type: "array", valueType: { type: "number" } } } } } }
        ], [
            "/types/destructurizing:RestDestr.z",
            { type: "index_access", index: { type: "constant", value: 2 }, object: { type: "index_access", index: { type: "constant", value: "x" }, object: { type: "object", properties: { x: { type: "array", valueType: { type: "number" } } } } }, rest: true }
        ]]);
}
