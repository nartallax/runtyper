function (exports, require, __RuntyperAutogeneratedImport) {
    __RuntyperAutogeneratedImport.Runtyper.internal.t([[
            ...
            "/types/recursive_type:DivPrinter",
            { type: "alias", body: { type: "type_reference", name: "/types/recursive_type:Printer", typeArguments: [{ type: "type_reference", name: "/types/recursive_type:Div" }] } }
        ], [
            ...
            "/types/recursive_type:Printer",
            { type: "alias", body: { type: "object", properties: { printedValue: { type: "generic_parameter", name: "T" } } }, typeParameters: [{ name: "T" }] }
        ], [
