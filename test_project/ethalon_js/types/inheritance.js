function (exports, require, __RuntyperAutogeneratedImport) {
    __RuntyperAutogeneratedImport.Runtyper.internal.t([[
            ...
            { type: "interface", properties: { name: { type: "string", optional: true } }, heritage: [{ type: "type_reference", name: "/types/inheritance:Wrap", typeArguments: [{ type: "generic_parameter", name: "T" }] }], typeParameters: [{ name: "T" }] }
        ], [
